  ...
  initGlobalDictInfo()
  {
    ...
    this.globalData.dictInfo =   {"_id":"2.1","modes":["识记模式","检验模式","复习模式"],"dictNames":{
        "生命科学":
        {
            ...
            "分子生物学":{"paper_count":75205.0,"diff_showcase":["case","capacity","digest","lncRNA","vital","phenyl","pole","fluid","penetrate","proton"]},
            "神经&认知":{"paper_count":51713.0,"diff_showcase":["temporal","assume","microscope","glucose","poly","excite","propagate","dysfunction","cardiac","gait"]},
            "生信&计算":{"paper_count":18965.0,"diff_showcase":["network","database","reconstruct","indices","discharge","cortex","fuzzy","probe","primer","poisson"]},
            "肿瘤学":{"paper_count":69863.0,"diff_showcase":["reduce","program","inter","locate","facility","ultra","germ","PCA","stain","sarcoma"]}
        },
        "医学":
        {
            "医学基础":{"paper_count":135133,"diff_showcase":["DNA", "load", "recurrent", "insight", "impact", "residue", "eliminate", "scaffold", "embryo", "aureus"]},
            "肿瘤学":{"paper_count":69863.0,"diff_showcase":["reduce","program","inter","locate","facility","ultra","germ","PCA","stain","sarcoma"]}
        }
    },
